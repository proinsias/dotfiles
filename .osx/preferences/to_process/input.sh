...
# Macbook Air
defaults -currentHost write -g com.apple.keyboard.modifiermapping.1452-588-0 -array-add '<dict><key>HIDKeyboardModifierMappingDst</key><integer>2</integer><key>HIDKeyboardModifierMappingSrc</key><integer>0</integer></dict>'
